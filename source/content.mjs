...
export const caseStudies = [
  ...
  },
  {
    ...
    light: true,
    summary: 'An agentic platform that connects the company’s AI agents and platforms and gives management one holistic view of them, with a single kill switch.',
    roleTitle: 'What it is',
    role: 'As the number of production agents and AI platforms grew (category intelligence, marketing, voice and chat agents, lead enrichment, RFQ, customer and vendor intelligence, collections), each one ran and reported on its own. Nexus is being built with Claude Code as the layer above them: it connects every platform, shows management what the whole estate is doing in one place, and puts all of it behind one kill switch. It is work in progress.',
    details: {
      title: 'Design',
      items: [
    ...
    maskNote: 'Captured from the Nexus prototype. The company is shown as the fictional Northwind, every figure is masked with “X”, and internal system addresses are replaced, all in the page before capture. The dashboard’s charts are drawn on a canvas that can’t be masked, so that view stops above them.',
    shots: [
      ['01-executive-dashboard.png', 'The executive dashboard: headline KPIs and the end-to-end flow across every connected platform, from discovery and engagement to conversion and revenue.'],
      ['02-agent-topology-map.png', 'The topology: data sources feed the AI platforms, all connected through AWS EventBridge as the central integration hub.'],
      ['03-integration-hub.png', 'The integration hub: each connected platform, what it does, and Zoho CRM as the single source of truth.'],
      ['04-tech-architecture.png', 'The technology architecture, layered from AWS infrastructure through the core business systems.'],
      ['05-control-panel.png', 'The control plane: every platform and agent has its own on/off switch to isolate issues, next to live sync status with the CRM.'],
    ],
  },
  {
    slug: 'property-nex',
    name: 'Property Nex',
    kicker: 'Real-estate data platform · concept',
    badge: 'Concept',
    light: true,
    summary: 'A platform concept that turns scattered property data into a data product that commercial companies can buy.',
    roleTitle: 'The idea',
    role: 'Real-estate data sits with many different property owners, developers, brokers and agencies, each holding it in its own format. It is hard to analyse and impossible to sell as a product, even though banks, insurers, retailers, logistics firms and investors need exactly this data to decide where to lend, insure, open and invest. Property Nex is a concept for closing that gap: find the property clients who hold the data, bring it into one consistent model, and offer it through a platform where commercial companies can buy the data they need.',
    details: {
      title: 'How it would work',
      items: [
        'Find and analyse property clients: identify who holds valuable property data, what they hold and what it is worth.',
        'Collect and process the data: ingest each source, then clean, de-duplicate and normalise it into one property data model.',
        'Build the data module: enrich and package the data into ready-to-use datasets by location, asset type and time period.',
        'Launch the platform: a marketplace where commercial companies browse, license and download the datasets, with access controlled per buyer.',
        'Share the value: property clients earn from data that was previously unused, and buyers get one reliable source instead of many partial ones.',
      ],
    },
    concept: ['Property clients', 'Collect & clean', 'Data module', 'Data platform', 'Commercial buyers'],
    conceptNote: 'Concept illustration. Property Nex is an idea, not a delivered product.',
    shots: [],
  },
  {
    slug: 'avar-systems',
