...
export const caseStudies = [
  ...
  },
  {
    ...
    maskNote: 'Proof-of-concept screens. All figures, partners and prices are illustrative sample data.',
    shots: [
      ['01-platform-overview.png', 'Platform overview: records processed and licensed, active partners, published datasets, and demand by buyer segment.'],
      ['02-data-sources-partner-analysis.png', 'Data sources: each property client is analysed and scored before it becomes a source.'],
      ['03-data-studio-pipeline.png', 'Data Studio: one pipeline from raw files to a canonical model, with schema mapping and quality checks on every run.'],
      ['04-dataset-module.png', 'The dataset module packages processed records into products buyers can license.'],
      ['05-buyer-marketplace.png', 'The buyer’s view: preview a dataset and pick a licence (snapshot, subscription or enterprise API).'],
      ['06-partner-revenue-share.png', 'Partner payouts: licence revenue attributed back to the property clients whose data built each dataset.'],
    ],
  },
  {
    slug: 'avar-systems',
